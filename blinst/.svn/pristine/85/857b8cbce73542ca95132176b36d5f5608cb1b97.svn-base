from numpy import tan,pi,sin
from periodictable import xsf
from blutil.calc import mirrorRejection
from blutil.calc import mirrorReflectivity
from blutil.calc import mirrorReflectivityPlotFixedA
from blutil.calc import mirrorReflectivityPlotFixedE
...
class HRMS:
  def __init__(self,m1r,m1y,m2r,m2y,linac,park_m1r=0.0,park_m1y=20.0,park_m2r=-180.0,park_m2y=20.0):
    ...
    self.linac = linac
    self._length=0.2
    self.mirrorRejection = mirrorRejection
    self.mirrorReflectivity = mirrorReflectivity
    self.mirrorReflectivityPlotFixedA = mirrorReflectivityPlotFixedA
    self.mirrorReflectivityPlotFixedE = mirrorReflectivityPlotFixedE
