...
class BeLens:
    ...
    def __init__(self,mot_x,mot_y,mot_z,lens_set_file=config.DEFAULT_LENS_SET,setposx=None,setposy=None,fwhm_unfoc=800e-6,desc="Be Lens System"):
        self.x=mot_x
        self.y=mot_y
        self.z=mot_z
        ...
        self._setposx=setposx
        self._setposy=setposy
        self._out=80
        self.__desc=desc
