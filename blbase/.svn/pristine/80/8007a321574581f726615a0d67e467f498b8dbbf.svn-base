...
class DG645(object):
  ...
  def __init__ (self,unit="XPP:MOB:DDG:01"):
    self.unit=unit
    self.chAB = DG645_channel(unit,"AB")
    self.chCD = DG645_channel(unit,"CD")
    self.chEF = DG645_channel(unit,"EF")
    self.chGH = DG645_channel(unit,"GH")
